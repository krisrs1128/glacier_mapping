...
if __name__ == '__main__':
    ...
    pconf["split_method"]["geographic_split"]["geojsons"]["train"] = train_path.replace("FOLD_NUM", str(i))
    pconf["split_method"]["geographic_split"]["geojsons"]["test"] = test_path.replace("FOLD_NUM", str(i))
