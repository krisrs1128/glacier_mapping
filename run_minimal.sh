...
python3 -m src.infer -m $DATA_DIR/runs/minimal_run/models/model_305.pt -i $DATA_DIR/raw/img_data/mini/LE07_143039_20051001.tif
...
python3 -m web_backend.backend_data -d /mnt/blobfuse/glaciers/outputs/pred_tiles/ -o /mnt/blobfuse/glaciers/outputs/pred_tiles_vrt -n y_hat.vrt --bandList 1 --tile True # tiles/ directory must exist
